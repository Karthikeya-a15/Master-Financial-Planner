import cryptoController from "../../put/cryptoController.js";
...
describe("cryptoController", () => {
  it("should update crypto data for a valid user and valid input", async () => {
    ...
    expect(res._getJSONData()).toEqual({
      message: "Crypto updated successfully to Networth",
    });
  ...
  it("should return 403 if input is invalid", async () => {
    ...
    cryptoSchema.safeParse.mockReturnValue({
      success: false,
    ...
    expect(res._getJSONData()).toEqual({
      message: "Crypto inputs are wrong",
