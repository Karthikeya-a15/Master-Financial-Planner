import getMiscellaneousController from "./getMiscellaneousController.js";
...
describe("getMiscellaneousController", () => {
    it("should return miscellaneous data for a valid user", async () => {
        ...
        expect(miscellaneous.findById(mockUser.netWorth.miscellaneous).select).toHaveBeenCalledWith('-_id -__v');
    });
