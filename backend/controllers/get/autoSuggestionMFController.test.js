...
import autoSuggestionMFController from "./autoSuggestionMFController.js";
...
describe('autoSuggestionMFController', () => {
  ...
  it('should return filtered funds based on name and category', async () => {
    ...
    const req = createRequest({ query: { name: 'fund a', category: 'flexi/multi cap' } });
    ...
    it('should return filtered funds based on name and category with multi cap funds', async () => {
      const req = createRequest({ query: { name: 'fund c', category: 'flexi/multi cap' } });
      const res = createResponse();
