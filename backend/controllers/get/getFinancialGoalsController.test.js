import getFinancialGoalsController from "./getFinancialGoalsController.js";
...
describe("getFinancialGoalsController", () => {
    it("should return financial goals and related data for a valid user", async () => {
        ...
        const mockUser = { _id: mockUserId, goals: "67b82107183c091d4d3990d7", ram: "67b82107183c091d4d3990d9", netWorth: { cashFlows: "67b82107183c091d4d3990c4" } };
        const mockGoals = { goals: [], sipAmountDistribution: [], sipAssetAllocation: [] };
        const mockReturnsAndAssets = { expectedReturns: {}, shortTerm: {}, mediumTerm: {}, longTerm: {} };
        const mockCashFlows = { inflows: { salary: 5000 }, outflows: { expenses: 2000 } };
        ...
        getCurrentInvestibleAssets.mockResolvedValue({ currentInvestibleAssets: mockCurrentInvestibleAssets });
        ...
        expect(CashFlows.findOne).toHaveBeenCalledWith({ _id: mockUser.netWorth.cashFlows });
