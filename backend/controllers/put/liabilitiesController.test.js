import liabilitiesController from "./liabilitiesController.js";
...
describe("liabilitiesController", () => {
    it("should update liabilities data for a valid user and valid input", async () => {
        ...
        const mockBody = { homeLoan: 60, educationLoan: 12, carLoan: 6, personalLoan: 3, creditCard: 2, other: 1 };
        const mockExistingLiabilities = { homeLoan: 50, educationLoan: 10, carLoan: 5, personalLoan: 2, creditCard: 1, other: 0 };
        ...
        liabilities.findOneAndUpdate.mockImplementation(() => ({
          ...
          homeLoan: 60, educationLoan: 12, carLoan: 6, personalLoan: 3, creditCard: 2, other: 1
        }));
        ...
        expect(res._getJSONData()).toEqual({ message: "Liabilities updated successfully to Networth" });
    ...
    it("should return 403 if input is invalid", async () => {
        ...
        liabilitiesSchema.safeParse.mockReturnValue({ success: false, error: mockValidationError });
        ...
        expect(res._getJSONData()).toEqual({ message: "Liabilities inputs are wrong", err: "Validation Error" });
        expect(liabilitiesSchema.safeParse).toHaveBeenCalledWith(mockBody);
    });
