  ...
  const calculateRD = () => {
    ...
    for (let year = 1; year <= years; year++) {
      ...
      const b = (e, t, n) => {
        let a = e / 100 / 12
          , r = e / 100 / 4;
        return Math.abs(parseInt(((2 * t * a + 4 * t * a + 3 * t) * (1 - (1 + r) ** (4 * n)) / (1 - (1 + r))).toString()))
    }

      const futureValue = b(rateOfInterest, monthlyDeposit, year);
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mt-1 text-secondary-600">
                Calculate returns on your Recurring Deposits
              </p>
            </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-xl font-bold text-secondary-900">
                        {formatCurrency(
                          yearlyResults[yearlyResults.length - 1].totalDeposit
                        )}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-success-600">
                        {formatCurrency(
                          yearlyResults[yearlyResults.length - 1].interest
                        )}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-primary-600">
                        {formatCurrency(
                          yearlyResults[yearlyResults.length - 1].futureValue
                        )}
                      </p>
                    </div>
