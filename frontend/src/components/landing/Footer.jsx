      ...
      <div className="container px-4 py-12 md:px-6 md:py-16">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="space-y-4">
            <Link to="/" className="font-bold text-xl inline-block">
              <span className="text-primary">Darw</span>-Invest
            </Link>
            <p className="text-sm text-muted-foreground">
              Your trusted partner on the journey to financial freedom and early retirement.
            </p>
          </div>
          <div className="space-y-4">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t pt-8 md:flex-row">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Darw-Invest. All rights reserved.
          </p>
