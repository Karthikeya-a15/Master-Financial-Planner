...
export default function FireCalculator() {
  ...
  return (
    ...
    >
      <h2 className="text-xl font-bold text-secondary-900 mb-4">FIRE Calculator</h2>
      <p className="text-secondary-600 mb-6">Calculate how much you need to achieve Financial Independence and Retire Early</p>
