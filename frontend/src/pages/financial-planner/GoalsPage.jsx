  ...
  const fetchGoalsData = async () => {
    try {
      ...
      const mockData = {
        goals: [
          {
            goalName: "Retirement",
            time: 25,
            amountRequiredToday: 50000000,
            amountAvailableToday: 5000000,
            goalInflation: 6,
            stepUp: 5,
            sipRequired: 45000
          },
          {
            ...
            time: 10,
            amountRequiredToday: 10000000,
            amountAvailableToday: 2000000,
            goalInflation: 8,
            stepUp: 10,
            sipRequired: 35000
          },
          {
            ...
            time: 5,
            amountRequiredToday: 8000000,
            amountAvailableToday: 1500000,
            goalInflation: 5,
            stepUp: 0,
            sipRequired: 95000
          },
          {
            goalName: "World Tour",
            time: 3,
            amountRequiredToday: 2000000,
            amountAvailableToday: 500000,
            goalInflation: 4,
            stepUp: 0,
            sipRequired: 40000
          }
        ...
        currentInvestibleAssets: 15000000,
        sipAmountDistribution: [
          {
            domesticEquity: 27000,
            usEquity: 4500,
            debt: 6750,
            gold: 2250,
            crypto: 2250,
          ...
          {goalsData?.goals?.length > 0 && goalsData?.sipAssetAllocation && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-secondary-900 mb-4">Recommended Investments</h3>
                  
                  <div className="space-y-4">
                    {Object.entries(goalsData.sipAssetAllocation).filter(([_, value]) => value > 0).map(([key, value]) => {
                      let recommendations = []
                      ...
                      return (
                        <div key={key} className="bg-secondary-50 p-4 rounded-lg">
                          <h4 className="font-medium text-secondary-900 capitalize mb-2">{key.replace(/([A-Z])/g, ' $1').trim()} ({formatCurrency(value)}/month)</h4>
                          <ul className="space-y-1 text-sm text-secondary-600">
                            {recommendations.map((rec, i) => (
                              <li key={i} className="flex items-center">
                                <svg className="h-4 w-4 text-success-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
