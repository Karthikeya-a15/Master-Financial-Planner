            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                    Status breakdown of goals by term length
                  </Typography>
                  ...
                  {loading ? (
                    ...
                    <BarChart
                      ...
                      series={[
                        {
                          data: [
                            completionData.shortTerm.completed,
                            completionData.mediumTerm.completed,
                            completionData.longTerm.completed
                          ],
                          label: "Completed",
                          color: theme.palette.success.main,
                          stack: "stack1"
                        ...
                        {
                          data: [
                            completionData.shortTerm.inProgress,
                            completionData.mediumTerm.inProgress,
                            completionData.longTerm.inProgress
                          ],
                          label: "In Progress",
                        ...
                        {
                          data: [
                            completionData.shortTerm.delayed,
                            completionData.mediumTerm.delayed,
                            completionData.longTerm.delayed
                          ],
                          label: "Delayed",
                          color: theme.palette.warning.main,
                          stack: "stack1"
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                    Percentage of goals completed or on track by category
                  </Typography>
